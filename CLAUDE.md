...
## ADR 1: Use Single Frontend Framework Only

1. Do not mix and match front end frameworks.

---

## ADR 2: Use Astro Files For Components

1. Use astro files for all components
